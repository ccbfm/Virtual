...
public enum SizeConverterUtils {
    ...
    Arbitrary {
        ...
        public String convert(float size) {
            ...
            return String.format(Locale.getDefault(), FORMAT_F, size);
        }
    },
    ...
    ArbitraryTrim {
        ...
        public String convert(float size) {
            ...
            return String.format(Locale.getDefault(), FORMAT_D, sizeInt);
        }
    },
    ...
    private static String converter(int unit, float size) {
        ...
        return String.format(Locale.getDefault(), FORMAT_F_UNIT, size, UNITS[idx]);
    }
    ...
    private static String trimConverter(int unit, float size) {
        ...
        return String.format(Locale.getDefault(), FORMAT_D_UNIT, sizeInt, UNITS[idx]);
    }
