...
public class GPSUtil {
    ...
    public static void main(String[] args) {
        double[] point = gps84_To_bd09(28.234532, 112.877369);
    ...
    private static String retain6Str(double num) {
        return String.format(Locale.getDefault(), "%.6f", num);
    }


    public static String[] changeLocation(double lat, double lon) {
        double[] point = gps84_To_bd09(lat, lon);
        return new String[]{retain6Str(point[0]), retain6Str(point[1])};
    }
}
